...
Source0  : https://files.pythonhosted.org/packages/d0/92/2ceaf3ac2110852983883411619f160053303c985573512fcd253e7058d3/azure-mgmt-hdinsight-2.0.0.zip
Summary  : Microsoft Azure HDInsight Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-hdinsight-python = %{version}-%{release}
Requires: azure-mgmt-hdinsight-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-hdinsight package.
Group: Default
Requires: azure-mgmt-hdinsight-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-hdinsight package.


%package python3
Summary: python3 components for the azure-mgmt-hdinsight package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_hdinsight)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-hdinsight package.


%prep
%setup -q -n azure-mgmt-hdinsight-2.0.0
cd %{_builddir}/azure-mgmt-hdinsight-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046370
